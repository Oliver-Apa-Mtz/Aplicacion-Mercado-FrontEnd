...
@Component({
  selector: 'app-publicacion-categoria',
...
export class PublicacionMostrarCategoriaComponent implements OnInit {
  ...
  public mensaje: any = 'Aun no hay publicaciones en esta categoria';
  ...
  ngOnInit() {
    ...
    this._route.params.subscribe(params => {
      ...
      this._publicacionService.obtenerPublicacionCategoria(this.token,params['categoria']).subscribe(
        response => {
