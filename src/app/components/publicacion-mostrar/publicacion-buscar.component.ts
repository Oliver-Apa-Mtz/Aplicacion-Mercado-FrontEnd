...
export class PublicacionMostrarBuscarComponent implements OnInit {
  ...
  public mensaje: any = 'No encontramos publicaciones que coincidan con la busqueda';
  ...
  ngOnInit() {
    ...
    this._route.params.subscribe(params => {
      this._publicacionService.obtenerPublicacionesBuscar(this.token,params['termino']).subscribe(
        response => {
